package ch.heig.christen_scherler;


import ch.heig.christen_scherler.integration.ContactDAORemote;
...
public class Init {
    ...
    public static void main(String... args) throws NamingException {
        ...
        ContactDAORemote contactDAO = (ContactDAORemote) ejbRemoteContext.lookup("java:global/reservations/ContactDAO!ch.heig.christen_scherler.integration.ContactDAORemote");
        contactDAO.create();
